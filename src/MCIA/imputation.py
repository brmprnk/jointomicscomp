...
trainFactorsFile = 'src/MCIA/geme_train_factors_20.csv'
...
dirName = 'embeddings/results/test_GE_ME_mcia_GE_ME/MCIA/'
...
save_dir = 'src/MCIA/imputation2from1'
...
save_dir = 'src/MCIA/imputation1from2'
os.makedirs(save_dir, exist_ok=True)
ckpt_dir = save_dir + '/checkpoint'
if not os.path.exists(ckpt_dir):
    os.makedirs(ckpt_dir)
...
individualPerfomanceSave = 'src/MCIA/imputation_GEME_performancePerDatapont.pkl'
